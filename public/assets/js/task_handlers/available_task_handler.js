                ...
                if (response.tasks.length === 0) {
                    ...
                    response.tasks.forEach(task => {
                      // Log the full task object
                        ...
                        let platformIcon = this.getPlatformIcon(task.platform); // Get platform icon URL
